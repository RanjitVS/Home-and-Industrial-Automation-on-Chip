...
SoftwareSerial BT(1,0); //TX, RX  pins of arduino respetively
String command;
void setup()
{
 BT.begin(9600);
...
void loop() {
  ...
  if(command == "load on") //this command will be given as an input to switch on light1
  {
    digitalWrite(2, HIGH);
  }
  else if(command == "load off") //this command will be given as an input to switch off light1 simillarly other commands work
  {
    digitalWrite(2, LOW);
  }
